...
void AProjectRPGCharacter::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
	...
	InputComponent->BindTouch(IE_Pressed, this, &AProjectRPGCharacter::TouchStarted);
	InputComponent->BindTouch(IE_Released, this, &AProjectRPGCharacter::TouchStopped);
}


void AProjectRPGCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
...
void AProjectRPGCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
	if (FingerIndex == ETouchIndex::Touch1)
	{
		StopJumping();
